                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm">Добавлен новый менеджер файлов с поддержкой drag & drop</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <Icon name="Plus" className="text-primary mt-1" size={16} />
                      <p className="text-sm">Улучшенный дизайн с эффектом жидкого стекла</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <Icon name="Wrench" className="text-secondary mt-1" size={16} />
                      <p className="text-sm">Оптимизация производительности на 40%</p>
                    </div>
                    <div className="flex items-start gap-2">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      <Icon name="Plus" className="text-primary mt-1" size={16} />
                      <p className="text-sm">Встроенный браузер приложений</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <Icon name="Plus" className="text-primary mt-1" size={16} />
                    ...
                    <div className="flex items-start gap-2">
                      <Icon name="Wrench" className="text-secondary mt-1" size={16} />
                      <p className="text-sm">Улучшена стабильность системы</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      <Icon name="Plus" className="text-primary mt-1" size={16} />
                      <p className="text-sm">Первый публичный релиз</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <Icon name="Plus" className="text-primary mt-1" size={16} />
                      <p className="text-sm">Базовый функционал операционной системы</p>
                    </div>
                  </div>
                </div>
              </div>
